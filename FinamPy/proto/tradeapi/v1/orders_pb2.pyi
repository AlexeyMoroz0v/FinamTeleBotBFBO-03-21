...
class OrderCondition(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["price", b"price", "time", b"time", "type", b"type"]) -> None: ...
...
class NewOrderResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "security_code", b"security_code", "transaction_id", b"transaction_id"]) -> None: ...
...
class CancelOrderRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "transaction_id", b"transaction_id"]) -> None: ...
...
class GetOrdersRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "include_active", b"include_active", "include_canceled", b"include_canceled", "include_matched", b"include_matched"]) -> None: ...
...
class GetOrdersResult(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "orders", b"orders"]) -> None: ...
